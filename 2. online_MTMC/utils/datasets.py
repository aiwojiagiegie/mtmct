...
class LoadImages:  # for inference
    ...
    def __next__(self, cam, fdx):
        ...
        img_name = self.path[:-1] + '%s_f%04d.jpg' % (cam, fdx)
...
class LoadImagesAndLabels(Dataset):  # for training/testing
    def __init__(self, path, img_size=640, batch_size=16, augment=False, hyp=None, rect=False, image_weights=False,
        ...
        # Cache images into memory for faster training (WARNING: large dataset may exceed system RAM)
        self.imgs = [None] * n
        if cache_images:
...
def extract_boxes(path='../coco/'):  # from utils.dataset import *; extract_boxes('../coco128')
...
def autosplit(path='../coco', weights=(0.9, 0.1, 0.0), annotated_only=False):
    ...
    Usage: from utils.dataset import *; autosplit('../coco')
    Arguments
