...
class Opts:
    def __init__(self):
        ...
        self.parser.add_argument('--version', type=str, default='n1', help='original image size (pixels)')
        ...
        self.parser.add_argument("--draw_debug", help="是否绘制debug视频", dest="draw_debug", type=bool, default="")
