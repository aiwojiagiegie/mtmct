...
if __name__ == '__main__':
    detection_path = f'output_HST/debug_单摄像头分析/44_pred.txt'
    gt_path = 'output_HST/debug_单摄像头分析/44_gt.txt'
    # calculate_results('gr ound_truth_validation.txt', f'ground_truth_validation.txt')
