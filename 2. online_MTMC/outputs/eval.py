...
def calculate_results(test_path, pred_path, mread=False, dstype='validation', roidir='/root/mtmct/dataset/AIC19/validation/S02'):
...
if __name__ == '__main__':
    version = opt.version
    detection_path = f'/root/mtmct/2. online_MTMC/outputs/result/version/yolov11/runs/model_name_yolov11n.pt/epochs_600/batch_32/997334/v1.txt'
